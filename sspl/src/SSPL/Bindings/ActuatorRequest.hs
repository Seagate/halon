                                                                                                                                 ...
                                                                                                                                 (Data.Text.pack "actuator_request_type",
                                                                                                                                  Data.Aeson.Schema.Types.empty{Data.Aeson.Schema.Types.schemaType = [Data.Aeson.Schema.Choice.Choice1of2 Data.Aeson.Schema.Types.ObjectType],
                                                                                                                                                                Data.Aeson.Schema.Types.schemaProperties = Data.HashMap.Lazy.fromList [(Data.Text.pack "systemd_service",
                                                                                                                                                                                                                                        Data.Aeson.Schema.Types.empty{Data.Aeson.Schema.Types.schemaType = [Data.Aeson.Schema.Choice.Choice1of2 Data.Aeson.Schema.Types.ObjectType],
                                                                                                                                                                                                                                                                      Data.Aeson.Schema.Types.schemaProperties = Data.HashMap.Lazy.fromList [(Data.Text.pack "systemd_request",
    ...
    where parseJSON (Data.Aeson.Types.Object obj) = do {let items = Data.HashMap.Lazy.toList obj
                                                         in Control.Monad.forM_ items GHC.Base.$ (\(pname,
                                                                                                    value) -> do
                                                                                                                ...
                                                                                                                let isAdditionalProperty = GHC.List.null matchingPatterns GHC.Classes.&& (pname `GHC.List.notElem` [Data.Text.pack "systemd_request",
                                                                                                                                                                                                                    Data.Text.pack "service_name"]);
                                                                                                                Control.Monad.when isAdditionalProperty (GHC.Base.fail "additional properties are not allowed"));
                                                        (Control.Applicative.pure ActuatorRequestActuator_request_typeSystemd_service Control.Applicative.<*> Data.Maybe.maybe (GHC.Base.fail "required property systemd_request missing") (\val -> case val of
                                                                                                                                                                                                                                                        Data.Aeson.Types.String str -> do GHC.Base.return str
                                                                                                                                                                                                                                                        _ -> GHC.Base.fail "not a string") (Data.HashMap.Lazy.lookup (Data.Text.pack "systemd_request") obj)) Control.Applicative.<*> Data.Maybe.maybe (GHC.Base.fail "required property service_name missing") (\val -> case val of
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Data.Aeson.Types.String str -> do GHC.Base.return str
...
instance Data.Aeson.ToJSON ActuatorRequestActuator_request_typeSystemd_service
    where toJSON (ActuatorRequestActuator_request_typeSystemd_service a1
                                                                      a2) = Data.Aeson.Types.Object GHC.Base.$ (Data.HashMap.Lazy.fromList GHC.Base.$ Data.Maybe.catMaybes [(,) (Data.Text.pack "systemd_request") Data.Functor.<$> (Data.Maybe.Just GHC.Base.. Data.Aeson.Types.String) a1,
